...
""""""""""""""""""""""""""""""""""""""""
  ...
  "set guifont=Meslo_LG_L_DZ_Regular_for_Powerline:h15
  " set guifont=Droid_Sans_Mono_for_Powerline:h15
...
if has("gui_running")
  set transparency=10
  nnoremap <expr><F10> &transparency+40 >= 100 ? ":set transparency=0\<CR>" : ":let &transparency=&transparency+10\<CR>"
endif
